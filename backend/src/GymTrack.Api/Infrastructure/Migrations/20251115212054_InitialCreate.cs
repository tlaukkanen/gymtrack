        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondaryMuscle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DefaultRestSeconds = table.Column<int>(type: "int", nullable: false, defaultValue: 60),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Units = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "metric"),
                    DefaultRestSeconds = table.Column<int>(type: "int", nullable: false, defaultValue: 60),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestSeconds = table.Column<int>(type: "int", nullable: false, defaultValue: 60),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WorkoutProgramExerciseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Sequence = table.Column<int>(type: "int", nullable: false),
                    TargetWeight = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExerciseSets_WorkoutProgramExercises_WorkoutProgramExerciseId",
                        column: x => x.WorkoutProgramExerciseId,
                        principalTable: "WorkoutProgramExercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProgramExerciseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    OrderPerformed = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutSessionExercises_WorkoutProgramExercises_ProgramExerciseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedWeight = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseMuscleEngagements_ExerciseId",
                table: "ExerciseMuscleEngagements",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_ExerciseSets_WorkoutProgramExerciseId",
                table: "ExerciseSets",
                column: "WorkoutProgramExerciseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutSessionExercises_ProgramExerciseId",
                table: "WorkoutSessionExercises",
